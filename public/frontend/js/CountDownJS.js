...
function CountDownObject() {
	...
	function TimerEnd(){
		...
		CanvasContext.font = 60*param.elementSize + "px Cairo";
	...
	function AllImages(){
		...
		this.colons = function(){
			...
			CanvasContext.font = 64*param.elementSize + "px Cairo";
			CanvasContext.textAlign = "center";
			CanvasContext.save();
			if(num > 2){
	...
	function DrawText(){
		CanvasContext.fillStyle = textC;
		CanvasContext.font = 25*param.elementSize + "px Cairo";
		CanvasContext.textAlign = "center";
		
		if(num == 1){
			CanvasContext.fillText("ثواني", param.sec1Position + 80*0.5*param.elementSize, 150*param.elementSize);
		}else{
			CanvasContext.fillText("ثواني", param.sec1Position - 80*0.05*param.elementSize, 150*param.elementSize);
		}
		if(num == 3){
			CanvasContext.fillText("دقائق", param.min1Position + 80*0.5*param.elementSize, 150*param.elementSize);
		}else if(num > 3){
			CanvasContext.fillText("دقائق", param.min1Position - 80*0.05*param.elementSize, 150*param.elementSize);
		}
		if(num == 5){
			CanvasContext.fillText("ساعات", param.hour1Position + 80*0.5*param.elementSize, 150*param.elementSize);
		}else if(num > 5){
			CanvasContext.fillText("ساعات", param.hour1Position - 80*0.05*param.elementSize, 150*param.elementSize);
		}
		if(num == 7){
			CanvasContext.fillText("يوم", param.day1Position + 80*0.5*param.elementSize, 150*param.elementSize);
		}else if(num == 8){
			CanvasContext.fillText("يوم", param.day1Position - 80*0.05*param.elementSize, 150*param.elementSize);
		}else{
			CanvasContext.fillText("يوم", param.day1Position - 80*0.6*param.elementSize, 150*param.elementSize);
		}
	}
	...
	function resizeCanvas(){
		...
		height = 150.1*param.elementSize + 20;
