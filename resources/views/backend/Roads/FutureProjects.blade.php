                ...
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"
                            action="{{route('admin.roads.future_projects')}}" method="post">
                            @csrf
                            @method('patch')
...
var demoBaseConfig = {
  ...
  toolbar:
    "insertfile a11ycheck undo redo | bold italic fontsizeselect  | forecolor backcolor | template codesample | alignleft aligncenter alignright alignjustify | bullist numlist | link image",
  content_css: [
