...
<body>
            ...
            <div class="search">
                <form>
                    <div class="form-row align-items-center">
                        ...
                        <div class="col-auto">
                            <label class="sr-only" for="inlineFormInputGroup">ابحث هنا</label>
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="#">نبذة تاريخية عن الهيئة</a>
                            <a class="dropdown-item" href="#">الهيكل التنظيمي</a>
                            <a class="dropdown-item" href="#">دور و اهمية الهيئة</a>
                            <a class="dropdown-item" href="#">قيادات الهيئة</a>
                            <a class="dropdown-item" href="#">موقع الهيئة</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button"
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">مناقصات</a>
                    </li>
                    <li class="nav-item">
    ...
    <section class="main-news">
        ...
        <div class="news-head">
            <div class="container">
                <div class="head vertical-line">
                    <h3>المشروعات المنفذةبالمنطقة</h3>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">الرئيسية </a></li>
                            <li class="breadcrumb-item active" aria-current="page"> المشروعات المنفذةبالمنطقة </li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container">
            <p class="roads-desc">مشروعات الطرق التى تم تنفيذها بالمنطقة فى الفترة 2014-2019</p>
        </div>
        ...
        <div class="roads">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="road text-center">
                            <div class="row">
                                <div class="col-6 road-info">
                                    <p>اسم المشروع : رفع كفاءة طريق كفر الدوار / ابو المطامير</p>
                                    <p>موقع المشروع : البحيرة</p>
                                    <p>طول الطريق : 35 كم</p>
                                </div>

                                <div class="col-6 col-md-3">
                                    <img src="/frontend/images/36708757-v2_xlarge.jpg" alt="not found">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                        <div class="col-12">
                            <div class="road text-center">
                                <div class="row">
                                    <div class="col-6 road-info">
                                        <p>اسم المشروع : رفع كفاءة طريق كفر الدوار / ابو المطامير من كم 8 حتى كم 20</p>
                                        <p>موقع المشروع : البحيرة</p>
                                        <p>طول الطريق : 35 كم</p>
                                    </div>
    ...
    <footer>
        ...
        <div class="copyright">
            <div class="container">
                <div class="copy">
                    <p>حقوق النسخ © 2019 الهيئة العامة للطرق والكباري والنقل البري - مصر </p>
                    <ul>
