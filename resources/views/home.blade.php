...
<head>
    ...
    <link rel="icon" href="../backend/build/images/favicon.ico" type="image/ico" />
                ...
                <div class="left_col scroll-view">
                    ...
                    <div class="profile clearfix">
                        <div class="profile_pic">
                            <img src="../backend/build/images/user.png" alt="..." class="img-circle profile_img">
                        </div>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            {{-- <li class="">
                                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown"
                                    aria-expanded="false">
                                    <img src="../backend/build/images/img.jpg" alt="">مرتضی کریمی
                            ...
                            <li role="presentation" class="dropdown">
                                ...
                                <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                                    <li>
                                        <a>
                                            <span class="image"><img src="../backend/build/images/img.jpg"
                                            ...
                                            <span class="message">
                                                فیلمای فستیوال فیلمایی که اجرا شده یا راجع به لحظات مرده ایه که فیلمسازا
                                                میسازن. آنها جایی بودند که....
                                            </span>
                                        </a>
                                    </li>
                                    <li>
                                            ...
                                            <a href="#">
                                                <div class="mail_list active">
                                                    ...
                                                    <div class="left">
                                                        ...
                                                        <p><span class="badge">To</span> تمرکز بیشتر بر روی تمرینات
                                                            ورزشی، تمرینات
                                                            ذهنی و ...</p>
                                                    </div>
                                                </div>
                                            ...
                                            <a href="#">
                                                <div class="mail_list">
                                                    ...
                                                    <div class="left">
                                                        ...
                                                        <p><span class="badge">CC</span> تمرکز بیشتر بر روی تمرینات
                                                            ورزشی، تمرینات
                                                            ذهنی و ...</p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="inbox-body">
                                                <div class="mail_heading row">
                                                    <div class="col-md-8">
                                                        <div class="btn-group">
                                                            ...
                                                            <button class="btn btn-sm btn-default" type="button"
                                                                data-placement="top" data-toggle="tooltip"
                                                                data-original-title="چاپ"><i
                                                                    class="fa fa-print"></i></button>
                                                            <button class="btn btn-sm btn-default" type="button"
                                                                data-placement="top" data-toggle="tooltip"
                                                                data-original-title="سطل آشغال"><i
                                                    ...
                                                    <div class="col-md-12">
                                                        <h4> لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و
                                                            با استفاده
                                                ...
                                                <div class="view-mail">
                                                    <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با
                                                        ...
                                                        زبان فارسی
                                                        ایجاد کرد.</p>
                                                    <p>کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان
                                                        جامعه و
                                                        ...
                                                        طراحان گرافیک
                                                        است. </p>
                                                    <p>چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم
                                                        است و برای
                                                        شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود
                                                        ابزارهای
                                                        کاربردی می باشد. در این صورت می توان امید داشت که تمام و دشواری
                                                        موجود در
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="#" class="atch-thumb">
                                                                <img src="../backend/build/images/inbox.png"
                                                                    alt="img" />
                                                            </a>
